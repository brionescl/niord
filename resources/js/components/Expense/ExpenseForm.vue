                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-8">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input id="amount" name="amount" type="text" pattern="\d*" class="form-control" placeholder="$10.000" v-model="expense.amount">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12">
                            ...
                            <textarea id="description" name="description" class="form-control" rows="3" placeholder="Description" v-model="expense.description"></textarea>
                        </div>
                    </div>
                </div>
